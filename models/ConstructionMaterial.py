...
class ConstructionMaterialTradeSymbol(Enum):
...
class ConstructionMaterial:
    tradeSymbol: Literal[ConstructionMaterialTradeSymbol]
    required: int
    fulfilled: int

construction_material = ConstructionMaterial
construction_material_trade_symbol = ConstructionMaterialTradeSymbol